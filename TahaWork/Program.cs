...
//haris.ComplexDesign("Owais Ahmed Khan");
//haris.SimpleDesign();
...
public class Shopping
{
    ...
    {
        Console.WriteLine("You have bought Eatables {0} at Rs. {1} . {2} .", name, price, desc);
    }

    public static void GetGadgets(string name, int price, string desc) 
    { 
        Console.WriteLine(" You have bought Gadgets {0} at Rs. {1} . {2} .", name, price, desc);
...
public class Payment
{
    ...
    public static void CreditCardPayment(double amount, string method)
    {
        Console.WriteLine("Processed credit card payment of Rs. {0} using {1}.", amount, method);
    }

    public static void CashPayment(double amount, string method)
    {
        Console.WriteLine("Processed cash payment of Rs. {0} using {1}.", amount, method);
    }
